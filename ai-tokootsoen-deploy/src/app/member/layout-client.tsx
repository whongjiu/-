...
export default function MemberLayoutClient({ name, navItems, children }: Props) {
  ...
  const mobileNavItems = [
    ...
    { label: "值日管理", path: "/member/schedule", icon: "📅" },
    { label: "数据统计", path: "/member/report", icon: "📄" },
    { label: "个人中心", path: "/member", icon: "👤" },
  ];
